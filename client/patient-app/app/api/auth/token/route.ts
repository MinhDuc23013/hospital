...
// [AUDIT FIX F11] The idToken is stored server-side only (never in client session).
...
export async function GET() {
  ...
  // Cast through unknown to access the JWT-level field set in auth-config jwt callback.
